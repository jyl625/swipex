...
class BarchartData extends React.Component {
  ...
  loadData() {
    let data = [
      ...
      { preDate: 2, amount: 4, date: "2021-11-02", closePrice: 8.17 },
      ...
      { preDate: 10, amount: 4, date: "2021-11-10", closePrice: 8.7 },
      ...
      { preDate: 18, amount: 8, date: "2021-11-18", closePrice: 7.66 },
